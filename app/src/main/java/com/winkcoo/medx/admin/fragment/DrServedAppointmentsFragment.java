 ...
 */
public class DrServedAppointmentsFragment extends Fragment implements ApiListener.appoinetmentsDownloadListener {
    Context context;
    ...
    public DrServedAppointmentsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Api.getInstance().getAppointments(TOKEN, "doctor", "" + commonUserModel.getId(), "3", this);
