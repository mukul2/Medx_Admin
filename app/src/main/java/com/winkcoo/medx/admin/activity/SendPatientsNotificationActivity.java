...
public class SendPatientsNotificationActivity extends AppCompatActivity {
        ...
        cardSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (body.length() > 0) {
                    ...
                    Api.getInstance().notice_add_by_user_type(TOKEN, "p", body, new ApiListener.NotificationPostListener() {
                        @Override
