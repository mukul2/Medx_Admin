 ...
 */
public class DrListFragmentAdmin extends Fragment implements ApiListener.UserDownloadListener {
    View view;
    Context context;
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;

    public static DrListFragmentAdmin newInstance() {
        DrListFragmentAdmin fragment = new DrListFragmentAdmin();
        return fragment;
    }


    public DrListFragmentAdmin() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_dr_list_fragment_admin, container, false);
        context = view.getContext();
        ButterKnife.bind(this, view);
        Api.getInstance().getUsersList("Bearer " + loginResponse.getAccessToken(), "d", this);
        return view;
    }
